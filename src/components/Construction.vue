...
<div class="container">
    ...
    <div class="content">
        ...
        <p class="box">
            ...
            The available pools remains the same regardless of which flagship (secretary) you use for construction. <br />
            ...
            <ul>
                ...
                <li><strong>Group 4</strong> - Do not meet any of the above requiurements.</li>
            </ul>
