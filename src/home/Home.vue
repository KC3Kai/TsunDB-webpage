...
<div class="container">
    ...
    <p class="subtitle">
        Welcome to the home of all the hard working tsunderes. Select one of the options at the top to get started. <img src="./../../assets/main/kasunuinui left.png" height="50px" width="50px"><br />
        I-It's not like I am doing this for you, you shitty admiral. 
    </P>
    <p class="subtitle">
        The current TsunDB version is <strong>Michishio</strong>.
    </p>
    <br />
    <p class="title">
        How do I submit data to the tsundere-database?
    </p>
    <p class="subtitle">
